...
<button type="submit" name="deleteRideTrigger" class="form-control btn btn-primary">CONFIRM DELETE RIDE</button>
<br/>
</form>
</div>
</div>
...
<?php
        ...
        if (isset($_POST['deleteRideTrigger'])) {

            $delete_ride_query = /** @php text */
                "DELETE FROM ride WHERE ride_id = '$target_rideID'";


            $delete_ride_result = pg_query($dbconn, $delete_ride_query);

            echo "<h1 class='text-center'>Ride deleted successfully  <h1/>";
